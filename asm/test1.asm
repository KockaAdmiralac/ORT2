        ...
        ADD (2000h)  ; Dodaje se 1000h na akumulator, A = 2000h    N = 0, Z = 0, C = 0, V = 0
        PUSH         ; Gura se 2000h na stek                       N = 0, Z = 0, C = 0, V = 0
        ST #3        ; Postavlja akumulator na 3                   N = 0, Z = 0, C = 0, V = 0
        ADD #-1      ; Smanjuje akumulator za 1                    N = ?, Z = ?, C = 0, V = 0
        BNNG -5      ; Skače na prethodnu instrukciju četiri puta  N = ?, Z = ?, C = 0, V = 0
        JSR funk     ; Skače na potprogram na labeli funk          N = 1, Z = 0, C = 0, V = 0
        INC R1       ; Inkrementira R1, R1 = 1
        LD (R1)      ; U akumulator učitava podatak na adresi 1, A = (IVTP + 1)
...
funk:   LD #1000h    ; Učitava se 1000h u akumulator
        ...
        BGREU -0b11  ; Vraća se na rotaciju dok se ne desi prekoračenje
